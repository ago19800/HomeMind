...
## [1.3.7] — 2026-03-23
  — ⚡Power Guard (contract threshold protection with 3 modes: warn/ask/auto), - fix: person.xxxxx, 🧠 Persistent Memory Learns your preferences over time, Task Scheduling. It is different from HA automations because you create them by speaking naturally and they are temporary.
