...
class TelegramBot:
    def __init__(self, token, allowed_chat_ids, ai_callback, action_callback,
                 ...
                 power_guard=None, rest_client=None, frigate_client=None):
        ...
        if self.ai_cb and self.context_cb:
            ...
            try:
                ...
                sys_prompt = (
                    ...
                    "  C) Esegui SEMPRE il comando temperatura richiesto con set_temperature\n"
                    "     Se HA restituisce errore, sarà HA stesso a comunicarlo — non bloccare a priori\n"
