...
STRINGS = {
    ...
    "commands_list": {
        "it": (
            ...
            "🔁 <b>Task Ripetuti:</b>\n"
            "  /task_ripetuti — lista task che si ripetono\n"
            "  /cancella_task_ripetuto N — cancella task ripetuto N\n"
            "  /cancella_task_ripetuto tutti — cancella tutti\n"
            "  <i>Ogni giorno alle 19 accendi la luce soggiorno</i>\n"
            "  <i>Ogni lunedì alle 9 accendi la presa lavatrice</i>\n"
            "  <i>Ogni sera alle 23 ricordami di prendere le medicine</i>\n\n"
            "🧠 <b>Memoria:</b>\n"
            "  /memoria — cosa so su di te\n"
            "  /dimentica &lt;testo&gt; — rimuovi un fatto dalla memoria\n"
            "  /memoria reset — cancella tutto e riparte da zero\n\n"
            "🔗 <b>Alias / Comandi Rapidi:</b>\n"
            "  /alias — vedi i tuoi alias personalizzati\n"
            "  memorizza che &lt;parola&gt; = &lt;sensor.xxx&gt; — leggi sensore\n"
            "  memorizza che &lt;parola&gt; = /energia — apri comando\n"
            "  dimentica alias — mostra lista per rimuovere\n"
            "  dimentica alias 1 — rimuove alias numero 1\n"
            "  cancella tutti gli alias — reset completo\n\n"
            "📖 <b>Documentazione:</b>\n"
            "  /readme — manuale completo HomeMind\n"
            "  /readme &lt;argomento&gt; — cerca sezione specifica\n"
            "  Es: /readme proximity, /readme briefing\n\n"
            "⚡ <b>Power Guard:</b>\n"
            "☀️ <b>Solare:</b>\n"
            ...
            "  <i>Cambia soglia Enel a 3500W</i>\n"
            "  <i>Notifica spazzatura alle 21</i>\n\n"
            "🗑️ <b>Spazzatura:</b>\n"
        ...
        "en": (
            ...
            "🔁 <b>Recurring Tasks:</b>\n"
            "  /task_ripetuti — list repeating tasks\n"
            "  /cancella_task_ripetuto N — cancel recurring task N\n"
            "  /cancella_task_ripetuto tutti — cancel all\n"
            "  <i>Every day at 7pm turn on living room light</i>\n"
            "  <i>Every monday at 9am turn on washing machine</i>\n"
            "  <i>Every evening at 11pm remind me to take medicine</i>\n\n"
            "🧠 <b>Memory:</b>\n"
            ...
            "  <i>Add person.mario to whitelist</i>\n"
            "  <i>Change Enel threshold to 3500W</i>\n"
            "  <i>Trash notification at 9pm</i>\n\n"
            "🗑️ <b>Trash:</b>\n"
