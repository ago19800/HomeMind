...
class HATools:
    def __init__(self, cache: dict, home, rest_client):
        self.cache = cache
        self.home  = home
    ...
    def _energy_block(self) -> str:
        """
        Legge TUTTI i sensori energia/potenza presenti in HA.
        Separati in: produzione istantanea (W), energia totale (kWh), batteria.
        """
        power_w   = []  # sensori W istantanei
        energy_kwh= []  # sensori kWh cumulativi (produzione giorno, totale, ecc.)
        battery   = []  # batteria
