...
function getAlarmCfg(){{
  ...
  return{{alarm_panel:panel,alarm_extra_panels:extra,alarm_auto_arm:aam,alarm_arm_mode:amode,
...
async function save(){{
  ...
  var ac=getAlarmCfg();if(ac.alarm_panel)cfg.alarm_panel=ac.alarm_panel;cfg.alarm_extra_panels=ac.alarm_extra_panels;cfg.alarm_auto_arm=ac.alarm_auto_arm;cfg.alarm_arm_mode=ac.alarm_arm_mode;cfg.alarm_disable_entities=ac.alarm_disable_entities;cfg.alarm_disable_notify=ac.alarm_disable_notify;
        ...
        if cfg_path.exists():
            try:
                ...
                UI_FIELDS = {
                    ...
                    "alarm_panel", "alarm_extra_panels", "alarm_auto_arm", "alarm_arm_mode",
