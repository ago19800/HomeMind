...
<div class="tabs">
  <button class="tab active" data-tab="p">👤 Persone</button>
  <button class="tab" data-tab="s">🚶 Sensori</button>
  <button class="tab" data-tab="z">🗑️ Spazzatura</button>
  <button class="tab" data-tab="e">⚡ Energia</button>
</div>
...
// Event delegation per i tab — evita problemi con onclick in iframe HA Ingress
